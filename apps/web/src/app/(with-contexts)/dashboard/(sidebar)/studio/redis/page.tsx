...
import { RotateCcw, Plus, Trash2, Edit } from "lucide-react";
    ...
    return (
      <DashboardContent breadcrumbs={[
        ...
        <div className="flex flex-col items-center justify-center min-h-[400px] gap-4">
          ...
          <p className="text-muted-foreground">You need admin privileges to access Redis Management.</p>
        </div>
      </DashboardContent>
    );
  }
                  ...
                  keys.map((keyInfo: RedisKeyInfo) => (
                    <div
                      ...
                      className={`p-2 border rounded cursor-pointer hover:bg-muted ${
                        selected?.key === keyInfo.key ? "bg-primary/10 border-primary" : ""
                      }`}
